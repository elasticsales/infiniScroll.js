(function() {
  ...
  _.extend(Backbone.InfiniScroll.prototype, Backbone.Events, {
    ...
    initialize: function() {
      ...
      if (!this.$contentEl.length || !jQuery.contains(document.documentElement, this.$contentEl[0])) throw new Error('contentEl must already be in DOM');
    ...
    destroy: function() {
      ...
      this.$scrollEl = this.$contentEl = null;
